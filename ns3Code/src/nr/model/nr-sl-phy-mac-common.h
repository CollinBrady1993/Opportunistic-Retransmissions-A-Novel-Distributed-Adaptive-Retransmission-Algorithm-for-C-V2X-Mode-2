...
struct SensingData
{
  ...
  SensingData (SfnSf sfn, uint16_t rsvp, uint8_t sbChLength, uint8_t sbChStart,
               ...
               uint8_t gapReTx2, uint8_t sbChStartReTx2,bool corrupt,uint8_t Rc,int srcRnti)
  {
    this->sfn = sfn;
    this->rsvp = rsvp;
...
struct SlotSensingData
{
  ...
  SlotSensingData (SfnSf sfn, uint16_t rsvp, uint8_t sbChLength, uint8_t sbChStart,
                   uint8_t prio, double slRsrp, bool corrupt,uint8_t Rc,int srcRnti)
  {
    this->sfn = sfn;
    this->rsvp = rsvp;
    this->sbChLength = sbChLength;
