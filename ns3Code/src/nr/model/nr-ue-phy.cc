  ...
  static TypeId tid = TypeId ("ns3::NrUePhy")
    ...
    .AddAttribute ("NoiseFigure",
                  ...
                  "In this model, we consider T0 = 290K.",
                   DoubleValue (0), // nr code from NYU and UniPd assumed in the code the value of 5dB, thats why we configure the default value to that
...
void
NrUePhy::PhyPscchPduReceived (const Ptr<Packet> &p, const SpectrumValue &psd,const bool &corrupt)
{
  if (!corrupt)
    {
      NS_LOG_FUNCTION (this);
     ...
     SensingData sensingData (m_currentSlot, sciF1a.GetSlResourceReservePeriod (),
                              ...
                              false, sciF1a.GetRc (), tag.GetRnti ());
