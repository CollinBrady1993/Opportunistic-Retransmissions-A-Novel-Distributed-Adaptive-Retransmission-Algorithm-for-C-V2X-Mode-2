...
MultiModelSpectrumChannel::StartTx (Ptr<SpectrumSignalParameters> txParams)
{
  ...
  //std::cout<<"MultiModelSpectrumChannel::StartTx called"<<std::endl; 
          ...
          if ((*rxPhyIterator) != txParams->txPhy)
            {
              ...
              //std::cout<<std::setprecision(30)<<*(rxParams->psd)<<std::endl; 
...
{
  NS_LOG_FUNCTION (this);
  //std::cout<<"MultiModelSpectrumChannel::StartRx called"<<std::endl;
