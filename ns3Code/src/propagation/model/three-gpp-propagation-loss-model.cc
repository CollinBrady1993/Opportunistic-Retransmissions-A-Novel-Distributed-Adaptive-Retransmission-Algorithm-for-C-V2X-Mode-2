...
{
  NS_LOG_FUNCTION (this);
  //std::cout<<std::setprecision(20)<<txPowerDbm<<std::endl;
  ...
  //std::cout<<std::setprecision(20)<<txPowerDbm<<std::endl;
  //std::cout<<std::setprecision(20)<<rxPow<<std::endl;
  ...
  //std::cout<<distance2d<<std::endl;
  //std::cout<<distance3d<<std::endl;
  //std::cout<<heights.first<<std::endl;
  //std::cout<<heights.second<<std::endl;
  //std::cout<<GetLoss (cond, distance2d, distance3d, heights.first, heights.second)<<std::endl;
  //std::cout<<std::setprecision(20)<<rxPow<<std::endl;
  return rxPow;
}
...
ThreeGppPropagationLossModel::GetShadowing (Ptr<MobilityModel> a, Ptr<MobilityModel> b, ChannelCondition::LosConditionValue cond) const
{
  ...
  if (notFound || newCondition)
  ...
  else
    {
      ...
      shadowingValue =  m_normRandomVariable->GetValue () * GetShadowingStd (a, b, cond);//R * it->second.m_shadowing + sqrt (1 - R * R) * m_normRandomVariable->GetValue () * GetShadowingStd (a, b, cond);
      //std::cout<<"pear"<<std::endl;
      //std::cout<<a->GetObject<Node> ()->GetId()<<std::endl;
      //std::cout<<b->GetObject<Node> ()->GetId()<<std::endl;
      //std::cout<<shadowingValue<<std::endl;
    }
